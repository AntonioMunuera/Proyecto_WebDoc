        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow" style="border-color: #cbdbe5;">
                ...
                <div class="card-body" style="color: #1b2530;">
                    <form action="/libreria/actualizar/<?= esc($libros->id) ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_categoria" id="id_categoria" class="form-control">
                                ...
                                <?php  foreach ($categoria as $categoriaItem) : ?>
                                    <option <?= $categoriaItem->id_categoria == old('id_categoria', esc($libros->id_categoria)) ? 'selected' : '' ?> value="<?= $categoriaItem->id_categoria ?>"><?= $categoriaItem->nombre ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="form-group">
